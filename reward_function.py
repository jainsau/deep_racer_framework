...
sample_params = {
    "all_wheels_on_track": random.choice([True, False]),        # Randomly True or False
    ...
    "is_crashed": random.choice([True, False]),                 # Randomly True or False
    "is_left_of_center": random.choice([True, False]),          # Randomly True or False
    "is_offtrack": random.choice([True, False]),                # Randomly True or False
    "is_reversed": random.choice([True, False]),                # Randomly True or False
    "heading": random.uniform(-180, 180),                       # Random heading between -180 and 180 degrees
    "objects_distance": [random.uniform(0, 50) for _ in range(5)],  # List of 5 random distances between 0 and 50 meters
    "objects_heading": [random.uniform(-180, 180) for _ in range(5)],  # List of 5 random headings between -180 and 180 degrees
    "objects_left_of_center": [random.choice([True, False]) for _ in range(5)],  # List of 5 random Boolean values
    "objects_location": [(random.uniform(0, 10), random.uniform(0, 10)) for _ in range(5)],  # List of 5 random (x, y) coordinates
